...
const ToastProvider = React.forwardRef(({ ...props }, ref) => (
  <div
    ref={ref}
    className="fixed bottom-[calc(4rem+env(safe-area-inset-bottom))] left-0 right-0 z-[100] flex max-h-[60vh] w-full flex-col-reverse items-center gap-2 px-3 pb-2 sm:bottom-0 sm:left-auto sm:right-0 sm:top-auto sm:max-h-screen sm:w-auto sm:flex-col md:max-w-[420px] sm:items-end sm:px-4"
    {...props}
  />
));
